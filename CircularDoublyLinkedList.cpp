  ...
  int Search(int value)
  {
    if(!IsEmpty())
    {
      ...
      do
      {
        if(temp->data==value)
        {
        	cout<<"searched number position - "<<pos<<endl;
          return pos;
        }
        pos++;
        temp=temp->next;
    ...
    cout<<"number "<<value<<" is not in the list"<<endl;
    return -1;
  }
};
...
int main()
{
  ...
  while(t!='9')
  {
	cout<<"\nSelect action by entering a number :"<<endl;
	cout<<"1.AddNode"<<endl;
    ...
    {
	  int pos;
      cout<<"enter new element position: ";
      cin>>pos;
      cout<<"enter new element value(number): ";
      cin>>value;
    ...
    {
      int pos;
      cout<<"Enter element position which you want to delete: ";
      cin>>pos;
      list.DeleteNode(pos);
    }
    else if(t=='3')
